    ...
    <div className="home-page-wrapper">
      <section className="hero">
        <div className="hero-text-wrapper">
          ...
          <Link to="/signup">
            <DefaultButton text="Get Started" className="hero-btn" />
          </Link>
        </div>
      ...
      <section className="search-creators">
        ...
        <Link to="/creator">
          <PrimaryButton
            text="Find a creator you love"
            className="find-creator-btn"
          />
        </Link>
      </section>
      <section className="crowdx-introduction">
        <div className="intro-contentwrapper">
          <h1>What's Crowdx?</h1>
          <p>
            On Crowdx, you can let your fans become active participants in the
            work they love by offering them a monthly membership. You give them
            access to exclusive content, community and insight into your
        ...
        <div className="testimonials-wrapper">
          <div className="testimonial">
            <div className="testimonial-description">
              ...
              <p>
                ...
                recurring income through monthly payments from your suppoerters.
              </p>
            </div>
            <div className="tesimonial-right">
              <div className="testimonial-images">
                <img
                  src="https://live-patreon-marketing.pantheonsite.io/wp-content/uploads/2020/12/mikki_kendallhomepageactual-6.png"
          ...
          <div className="testimonial">
            <div className="testimonial-left">
              <div className="testimonial-images">
                <img
                  src="https://live-patreon-marketing.pantheonsite.io/wp-content/uploads/2020/12/kevonstage.png"
                  alt="images-testimonials"
                />
              </div>
              <div className="testimonial-name">
              ...
              <div className="testimonial-content">
                <p>
                  “Creative independence means I don’t have to wait for any
                  person or platforms approval to make what I want to make. I
                  create what I want and my audience supports me. There is no
                  middle man.”
                </p>
              </div>
            </div>
          ...
          <div className="testimonial">
            ...
            <div className="testimonial-images">
              <img
                src="https://live-patreon-marketing.pantheonsite.io/wp-content/uploads/2020/12/2021-HomepagePhoto-Bexey.png"
                alt="images-testimonials"
              />
            </div>
          </div>
      ...
      <section className="page-description">
        ...
        <p>
          There are many ways to delight your fans and every creator does this
          in their own way.
        </p>
        <img
          src="https://live-patreon-marketing.pantheonsite.io/wp-content/uploads/2021/01/correcttestcarlos.jpeg"
          alt="creator"
        />
      </section>
      ...
      <section className="cta-bottom">
        ...
        <Link to="/signup">
          <PrimaryButton text="Get started" className="cta-btn" />
        </Link>
      </section>
